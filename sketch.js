...
var mixedGroup;
var marble, button, marbleImg, SignupLogin, title, teacherImg, studentImg, SignupImg1, LoginImg1, SignupImg2, LoginImg2, t1,t2, tsingup; 
...
function preload(){ 
  ...
  button=loadImage("Images/btn.png");   
...
function draw(){ 
  ...
  signup=createElement("h1");  
  
  signup.html("Sign-up");  
  signup.position(270,590); 

  signup.mousePressed(()=>{ 
    Redirect(); 
  }); 

  login=createElement("h1");  
  
  login.html("Login");  
  login.position(270,690); 
